 ...
 */
public abstract class HDFCBaseTest implements Corp_Framework_Constants {
    ...
    protected String url = HDFC_Test_DataByPropertyFILE.getData("base.url");
    protected String username = HDFC_Test_DataByPropertyFILE.getData("hdfc_username");
    protected String password = HDFC_Test_DataByPropertyFILE.getData("hdfc_password");
