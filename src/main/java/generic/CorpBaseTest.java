 ...
 */
public abstract class CorpBaseTest implements Corp_Framework_Constants {
    private static final Logger logger = LoggerUtil.getLogger(CorpBaseTest.class);
    
    protected WebDriver driver;
    protected WebDriverWait wait;
    protected JavascriptExecutor js;
    protected ExtentTest test;
    protected String url = Corp_Test_DataByPropertyFILE.getData("base.url");
    protected String username = Corp_Test_DataByPropertyFILE.getData("corpstack_username");
    protected String password = Corp_Test_DataByPropertyFILE.getData("corpstack_password");
