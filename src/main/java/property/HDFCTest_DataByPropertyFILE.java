 ...
 */
public class HDFCTest_DataByPropertyFILE {
    
    private static Properties properties;
    private static final String PROPERTY_FILE_PATH = "property/HDFC_test_data.properties";
     ...
     */
    public HDFCTest_DataByPropertyFILE() {
