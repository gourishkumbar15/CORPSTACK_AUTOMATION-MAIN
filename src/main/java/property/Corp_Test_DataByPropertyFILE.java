 ...
 */
public class Corp_Test_DataByPropertyFILE {
    
    private static Properties properties;
    private static final String PROPERTY_FILE_PATH = "property/Corp_test_data.properties";
     ...
     */
    public Corp_Test_DataByPropertyFILE() {
